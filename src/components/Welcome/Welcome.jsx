                                        ...
                                        <Container className="text-center mt-5">
                                            <Row>
                                                <Col lg={4} md={6} sm={12}>
                                                    ...
                                                    <p className="serviceDescription">Build a carier with us</p>
                                                </Col>

                                                <Col lg={4} md={6} sm={12}>
                                                    <img src={pagetwo} />
                                                    <h1 className="serviceName">The way what you want </h1>
                                                    <p className="serviceDescription">Build a carier with us</p>
                                                </Col>
                                                ...
                                                <Col lg={4} md={6} sm={12}>
                                                    ...
                                                    <p className="serviceDescription">Start from today</p>
                                                </Col>
                                            </Row>
                                                ...
                                                <Col lg={4} md={6} sm={12}>
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col lg={6} md={6} sm={12}>
                                                            ...
                                                            <p className="text-justify serviceDescription">Build Your Development Skill</p>
                                                        </Col>
                                                    </Row>
                                                </Col>
                                                ...
                                                <Col lg={4} md={6} sm={12}>
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col lg={6} md={6} sm={12}>
                                                            ...
                                                            <p className="text-justify serviceDescription">Build Your Web Design Skill</p>
                                                        </Col>
                                                    </Row>
                                                </Col>
                                                <Col lg={4} md={6} sm={12}>
...
<p className="text-justify serviceDescription">Learn Ecommerce Development</p>
     </Col>
</Row>
     </Col>
