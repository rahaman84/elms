                    ...
                    <Row>
                        <Col lg={6} md={12} sm={12}>
                            <Row>
                                ...
                                <Col lg={6} md={6} sm={12}>
                                    ...
                                    <h5 className="text-justify serviceName">Laravel 9  </h5>
                        ...
                        <Col lg={6} md={12} sm={12}>
                            <Row>
                                ...
                                <Col lg={6} md={6} sm={12}>
                                    <h5 className="text-justify serviceName">POS System  </h5>
                                    <p className="text-justify serviceDescription">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <Link className="courseViewMore float-left" to="/coursedetails" >View Details</Link>
                                </Col>
                                ...
                                <Col lg={6} md={6} sm={12}>
                                    <h5 className="text-justify serviceName">Newspaper CMS </h5>
                                    <p className="text-justify serviceDescription">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                    <Link className="courseViewMore float-left" to="/coursedetails" >View Details</Link>
                                </Col>
